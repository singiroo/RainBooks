...
<script type="text/javascript">
  	$(function(){
  		$('#GoHome').on('click', function(){
  			$('#changePageButtonForm').attr('action', 'Main');
...
<body>
	...
	<jsp:include page="payCompleatePage_content.jsp"></jsp:include>
<%-- 	<jsp:include page="payCompleatePage_footer.jsp"></jsp:include> --%>
</body>
</html>